<template>
  <div id="app">
    <div class="hint" ref="hint">
      ...
      <div style="width:100%;">
        <el-input type="textarea" :autosize="{ minRows:4, maxRows:10}" v-model="toolbar.sql" :style="{fontFamily:result.fontFamily,fontSize:result.fontSize+'px'}" class="sql-pannel" @keypress.native="panelInput" />
      </div>
